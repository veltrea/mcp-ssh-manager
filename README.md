...
### 📄 ドキュメント
- **[最新設計仕様書 (INTEGRATED_SPEC_PHASE_1-11.md)](file:///Users/user/Library/CloudStorage/GoogleDrive-veltrea@users.noreply.github.com/マイドライブ/dev/SSH_Dev/mcp-ssh-manager-private/INTEGRATED_SPEC_PHASE_1-11.md)**: プロジェクト全体の正典となる仕様書です。
- **[運用マニュアル (USER_MANUAL.md)](file:///Users/user/Library/CloudStorage/GoogleDrive-veltrea@users.noreply.github.com/マイドライブ/dev/SSH_Dev/mcp-ssh-manager-private/USER_MANUAL.md)**: ユーザー向けの操作ガイド。
