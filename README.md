...
本ツールは、純粋なRust実装によるポータブルなSSHクライアントである [**mcp-ssh**](https://github.com/veltrea/mcp-ssh) を強力にサポートし、その接続管理とセキュリティ機能を拡張するために設計されています。

単なる接続管理に留まらず、**TPM (Trusted Platform Module) / Secure Enclave** を活用したハードウェア識別鍵の生成と、**ゼロトラスト（Trust no one, Verify everyone）** 原則に基づく安全なアクセス制御を実現します。
